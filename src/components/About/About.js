    ...
    <div>
      ...
      <section id='about-section' className='about-outer-container'>
        ...
        <div className='about-info-container'>
          <p className='bio-text'>Southwest Electrolysis & Spa offers electrolysis, microneedling, microdermabrasion, dermaplaning, facials, and peels. Owner and operator Brenda Nemeroff has more than 30 years of experience in the esthetics and medical industries. She has dedicated her life to helping people elevate their wellness and beauty. Brenda is committed to delivering the best skincare possible with state of the art equipment and products, including Image Skincare.</p>
